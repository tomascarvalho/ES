...
<p>
    ...
    <strong># Tickets: <i>{{number_tickets_per_status[email]}}</i></strong>
</p>
        ...
        <td valign="top">
           ...
           % for ticket in sorted(tickets[priority], reverse=True):
                <tr>
                    ...
                    <td>
                        <a href="http://localhost:8080/Ticket/Display.html?id={{ticket['id']}}">
                            {{ticket['id']}}
                        </a>
                    </td>
                    <td>
                    ...
                    <td>
                        ...
                        <a href="/ticket/{{ticket['id']}}/action/done?o={{username_id}}&email={{email}}">done</a>
                        % end
                        % if email == 'dir-inbox':
